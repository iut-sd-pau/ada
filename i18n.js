...
const _T = {
  ...
  rule_four:{fr:'4 lettres exactement',en:'Exactly 4 letters'},rule_six:{fr:'6 lettres exactement',en:'Exactly 6 letters'},rule_len_even:{fr:'Nombre de lettres pair',en:'Even number of letters'},rule_len_odd:{fr:'Nombre de lettres impair',en:'Odd number of letters'},rule_end_s:{fr:'Se termine par S',en:'Ends with S'},rule_end_cons:{fr:'Se termine par une consonne',en:'Ends with a consonant'},rule_has_r:{fr:'Contient la lettre R',en:'Contains the letter R'},rule_repeat_letter:{fr:'Une lettre repetee',en:'A repeated letter'},
  ...
  av_skin:{fr:"Peau",en:"Skin"},av_face:{fr:"Visage",en:"Face"},av_eyes:{fr:"Yeux",en:"Eyes"},av_hair:{fr:"Cheveux",en:"Hair"},av_haircolor:{fr:"Couleur",en:"Color"},av_hat:{fr:"Accessoire",en:"Accessory"},av_aura:{fr:"Aura",en:"Aura"},av_outfitstyle:{fr:"Tenue (style)",en:"Outfit style"},av_outfit:{fr:"Tenue",en:"Outfit"},
  ...
  col_empty_slot:{fr:"Vide",en:"Empty"},col_bonus_coin:{fr:"+{V}% pieces",en:"+{V}% coins"},col_bonus_xp:{fr:"+{V}% XP",en:"+{V}% XP"},col_bonus_joker:{fr:"+{V} joker / partie",en:"+{V} joker / game"},col_bonus_luck:{fr:"+{V}% chance rare",en:"+{V}% rare luck"},col_bonus_time:{fr:"+{V}s de temps",en:"+{V}s time"},col_bonus_gem:{fr:"+{V} gemme / partie",en:"+{V} gem / game"},
  ...
  arc_item_won:{fr:"Accessoire d avatar gagne !",en:"Avatar item won!"},arc_card_won:{fr:"🃏 Carte obtenue !",en:"🃏 Card obtained!"},arc_react_wait:{fr:"Attends le vert…",en:"Wait for green…"},arc_react_now:{fr:"MAINTENANT !",en:"NOW!"},arc_react_early:{fr:"Trop tot ! Rate.",en:"Too early! Miss."},arc_react_ms:{fr:"{N} ms",en:"{N} ms"},
  ...
  /* ---- GUIDE / AIDE / COACH (ajout) ---- */
  menu_help:{fr:"Aide",en:"Help"},
  coach_title:{fr:"Bienvenue, Agent ! 👋",en:"Welcome, Agent! 👋"},
  coach_intro:{fr:"Voici comment te repérer dans le jeu. Tu pourras revoir ce guide quand tu veux dans ⚙️ Réglages.",en:"Here's how to find your way around. You can replay this guide anytime in ⚙️ Settings."},
  coach_daily:{fr:"🎯 Défi du jour : un défi unique, le même pour tout le monde, chaque jour.",en:"🎯 Daily challenge: one unique challenge, same for everyone, every day."},
  coach_modes:{fr:"🎮 Modes : joue en Solo, en Local (même appareil) ou en ligne dans l'Arène.",en:"🎮 Modes: play Solo, Local (same device) or online in the Arena."},
  coach_tabs:{fr:"Barre du bas : 🏠 Accueil · 🌍 Monde · 🕹️ Arcade · 👤 Profil · ⚙️ Réglages.",en:"Bottom bar: 🏠 Home · 🌍 World · 🕹️ Arcade · 👤 Profile · ⚙️ Settings."},
  coach_full:{fr:"📖 Voir le guide complet",en:"📖 See the full guide"},
  coach_ok:{fr:"J'ai compris ✓",en:"Got it ✓"},
  set_help_lbl:{fr:"Aide",en:"Help"},
  set_guide_name:{fr:"Revoir le tutoriel",en:"Replay tutorial"},
  set_guide_desc:{fr:"Le guide complet du jeu",en:"The full game guide"},
  set_guide_btn:{fr:"📖 Ouvrir le guide",en:"📖 Open guide"},
  guide_title:{fr:"Guide du jeu",en:"Game guide"},
  guide_skip:{fr:"Passer",en:"Skip"},
  guide_next:{fr:"Suivant →",en:"Next →"},
  guide_back_btn:{fr:"Retour",en:"Back"},
  guide_start:{fr:"C'est parti ! ⚡",en:"Let's go! ⚡"},
  guide_of:{fr:"sur",en:"of"},
  g_s1_t:{fr:"Le principe",en:"The idea"},
  g_s1_x:{fr:"FLASH BRAIN est un jeu de rapidité avec les mots. On te donne un <b>mot</b> et une <b>règle</b>. Tu réponds par un mot qui <b>commence par la même lettre</b> et qui respecte la règle — le plus vite possible.",en:"FLASH BRAIN is a fast word game. You get a <b>word</b> and a <b>rule</b>. Reply with a word that <b>starts with the same letter</b> and follows the rule — as fast as you can."},
  g_s1_word:{fr:"Mot donné",en:"Given word"},
  g_s1_rule:{fr:"Règle",en:"Rule"},
  g_s1_rule_ex:{fr:"Sans la lettre A",en:"No letter A"},
  g_s1_ans:{fr:"Bonne réponse",en:"Good answer"},
  g_s1_why:{fr:"Commence par S, sans A",en:"Starts with S, no A"},
  g_s2_t:{fr:"Le FLASH ⚡",en:"The FLASH ⚡"},
  g_s2_x:{fr:"Avant de répondre, appuie sur le bouton <b style='color:var(--fl)'>⚡ FLASH</b> pour réserver ta réponse.<br><br>En ligne, le <b>premier qui flashe</b> répond. S'il se trompe, les autres peuvent <em>voler</em> le point !",en:"Before answering, hit the <b style='color:var(--fl)'>⚡ FLASH</b> button to lock in your answer.<br><br>Online, the <b>first to flash</b> answers. If they're wrong, others can <em>steal</em> the point!"},
  g_s3_t:{fr:"Les modes de jeu",en:"Game modes"},
  g_mode_solo_t:{fr:"🧍 Entraînement Solo",en:"🧍 Solo Training"},
  g_mode_solo_x:{fr:"Joue seul, monte en niveau et gagne de l'XP à ton rythme.",en:"Play alone, level up and earn XP at your own pace."},
  g_mode_local_t:{fr:"👥 Multi Local",en:"👥 Local Multi"},
  g_mode_local_x:{fr:"2 à 10 joueurs sur le même téléphone, chacun son tour.",en:"2 to 10 players on the same phone, taking turns."},
  g_mode_online_t:{fr:"🌐 Arène Mondiale",en:"🌐 World Arena"},
  g_mode_online_x:{fr:"Crée une salle, partage le code à tes amis et jouez ensemble en direct.",en:"Create a room, share the code with friends and play together live."},
  g_s4_t:{fr:"Les onglets en bas",en:"The bottom tabs"},
  g_s4_x:{fr:"La barre du bas te permet de naviguer partout dans le jeu :",en:"The bottom bar lets you navigate everywhere in the game:"},
  g_tab_home_t:{fr:"🏠 Accueil",en:"🏠 Home"},
  g_tab_home_x:{fr:"Le défi du jour et tous les modes de jeu.",en:"The daily challenge and all game modes."},
  g_tab_world_t:{fr:"🌍 Monde",en:"🌍 World"},
  g_tab_world_x:{fr:"Classement mondial, salles en ligne, amis et compétitions.",en:"World leaderboard, online rooms, friends and competitions."},
  g_tab_arcade_t:{fr:"🕹️ Arcade",en:"🕹️ Arcade"},
  g_tab_arcade_x:{fr:"Mini-jeux rapides pour gagner des pièces et des jokers.",en:"Quick mini-games to earn coins and jokers."},
  g_tab_profile_t:{fr:"👤 Profil",en:"👤 Profile"},
  g_tab_profile_x:{fr:"Tes statistiques, ton grade, tes succès et tes amis.",en:"Your stats, rank, achievements and friends."},
  g_tab_settings_t:{fr:"⚙️ Réglages",en:"⚙️ Settings"},
  g_tab_settings_x:{fr:"Langue, sons, musique… et le bouton pour revoir ce guide.",en:"Language, sounds, music… and the button to replay this guide."},
  g_s5_t:{fr:"Le défi du jour 🎯",en:"The daily challenge 🎯"},
  g_s5_x:{fr:"Chaque jour, un défi <b>unique et identique pour tous les joueurs du monde</b>. Reviens chaque jour pour garder ta série et gagner de l'<em>XP doublée</em>.",en:"Every day, a <b>unique challenge that's the same for every player in the world</b>. Come back daily to keep your streak and earn <em>double XP</em>."},
  g_s6_t:{fr:"Cartes & collection 📒",en:"Cards & collection 📒"},
  g_s6_x:{fr:"Les <b>cartes</b> ne sont pas que de la déco : place-les dans ton <b>deck</b> (depuis la Collection) et leurs bonus s'appliquent à <b>chaque partie</b> — <em>+temps de réflexion</em>, <em>+pièces</em>, <em>+XP</em>, <em>+gemmes</em>, <em>jokers de départ</em> ou <em>chance</em> de tomber sur des cartes rares. Plus une carte est rare, plus son bonus est fort.<br><br><b>Comment en avoir :</b> en jouant, via le défi du jour, en ouvrant des packs à la Boutique, en gagnant à l'Arcade, ou en échangeant avec tes amis. Recycle tes doublons contre des pièces et des gemmes.",en:"<b>Cards</b> aren't just for show: put them in your <b>deck</b> (from the Collection) and their bonuses apply to <b>every game</b> — <em>+thinking time</em>, <em>+coins</em>, <em>+XP</em>, <em>+gems</em>, <em>starter jokers</em> or <em>luck</em> for rare cards. The rarer the card, the bigger the bonus.<br><br><b>How to get them:</b> by playing, via the daily challenge, opening packs in the Shop, winning in the Arcade, or trading with friends. Recycle duplicates for coins and gems."},
  g_s7_t:{fr:"Pièces, gemmes & jokers",en:"Coins, gems & jokers"},
  g_s7_x:{fr:"Tu gagnes des 🪙 <b>pièces</b> et des 💎 <b>gemmes</b> en jouant. Dépense-les à la <b>Boutique</b> pour des packs de cartes et des <b>jokers</b> : <em>Passer</em> une manche, <em>+5s</em>, ou un <em>Indice</em>.",en:"You earn 🪙 <b>coins</b> and 💎 <b>gems</b> as you play. Spend them in the <b>Shop</b> on card packs and <b>jokers</b>: <em>Skip</em> a round, <em>+5s</em>, or a <em>Hint</em>."},
  g_s8_t:{fr:"Rangs & XP 🏆",en:"Ranks & XP 🏆"},
  g_s8_x:{fr:"Chaque bonne réponse rapporte de l'<b>XP</b>. Plus d'XP = un grade plus élevé, de <b>Recrue 🪖</b> jusqu'à <b>Cosmos 🌌</b>, avec des bonus à chaque palier.",en:"Every correct answer earns <b>XP</b>. More XP = a higher rank, from <b>Recruit 🪖</b> all the way to <b>Cosmos 🌌</b>, with bonuses at every tier."},
  g_s9_t:{fr:"Astuces pour gagner",en:"Tips to win"},
  g_tip1:{fr:"Flashe tôt : la vitesse compte autant que le mot.",en:"Flash early: speed matters as much as the word."},
  g_tip2:{fr:"En ligne, garde un mot court en tête pour voler un point.",en:"Online, keep a short word ready to steal a point."},
  g_tip3:{fr:"Fais le défi du jour chaque jour pour ta série et l'XP ×2.",en:"Do the daily challenge every day for your streak and ×2 XP."},
  g_tip4:{fr:"Bloqué ? Utilise un joker Indice ou Passer (achetés à l'Arcade ou la Boutique).",en:"Stuck? Use a Hint or Skip joker (from the Arcade or Shop)."},
  g_end_t:{fr:"Prêt, Agent ?",en:"Ready, Agent?"},
  g_end_x:{fr:"Tu sais tout l'essentiel. Tu pourras <b>revoir ce guide à tout moment</b> dans ⚙️ Réglages.",en:"You know the essentials. You can <b>replay this guide anytime</b> in ⚙️ Settings."},
  /* ---- Partage defi du jour ---- */
  res_share_ttl:{fr:"Ton résultat du jour",en:"Your daily result"},
  res_share_btn:{fr:"📤 Partager mon score",en:"📤 Share my score"},
  res_share_copied:{fr:"Copié ! Colle-le où tu veux 📋",en:"Copied! Paste it anywhere 📋"},
  res_share_streak:{fr:"Série",en:"Streak"},
  /* ---- Mode enfant ---- */
  setup_kids:{fr:"Enfant",en:"Kids"},
  rule_kids:{fr:"Un mot qui commence pareil",en:"A word starting the same"},
  /* ---- Classement defi du jour ---- */
  res_daily_lb:{fr:"Classement du défi",en:"Daily ranking"},
  res_daily_players:{fr:"joueurs",en:"players"},
  res_daily_you_rank:{fr:"Tu es {N}e sur {T} aujourd'hui",en:"You're {N} of {T} today"},
};
